...
\begin{enumerate}[label=\textbf{\textbullet}, align=left, leftmargin=*]
	...
	\item[\textbf{Mittelwerte der Noten}] $\mkt$ (KT); $\mka$ (KA und GFS); $\mm$ (m)
	...
	\[
	\wdis = \left| \frac{0{,}5 - (\mseins \mod 1)}{\wth} \right|
	\,\hspace{1cm}\,
	...
	\end{cases}
	\]
	\item[\textbf{Gewichtungsfaktoren Verbesserung}] $\wveins$; $\wvzwei$; $\wvdrei$; $\wvvier$
	\[
	\wveins =
	\begin{cases}
		0 & \text{für }  \wdis \geq 1 \\
		\mhalf + \wth & \text{für }    \wdis < 1 \text{ und Notensystem N} \\
		\mhalf - \wth & \text{für }    \wdis < 1 \text{ und Notensystem NP} \\
	\end{cases}
	\,\,\,\,
	\wvzwei =
	\begin{cases}
	...
	\wvdrei =
	\begin{cases}
		0 & \text{für }  \wdis \geq 1 \text{ oder } \nvg=0 \\
		\frac{\wnull}{\wth} & \text{für } \wdis < 1 \text{ und } \nvg \neq 0 \\
	\end{cases}
	\,\,\,\,\,\,\,\,
	\wvvier =
	\begin{cases}
		0 & \text{für }  \wdis \geq 1 \text{ oder } \nvg=0 \\
		\frac{\nveins \cdot \wveins + \nvo \cdot \mseins + \wvzwei + \nvzwei \cdot \wvzwei}{\nvg} & \text{für }    \wdis < 1 \text{ und } \nvg \neq 0 \\
	\end{cases}
	\]	
