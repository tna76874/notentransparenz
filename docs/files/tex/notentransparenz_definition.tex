...
\begin{enumerate}[label=\textbf{(\arabic*)}, align=left, leftmargin=*]
	...
	\item \textbf{Ankündigung von Leistungen} { \thisfontsize \defkt, Nachschreibearbeiten (\defkt und \defka), \defsl, \defktp, \defkap~und \defm~sind in der Regel unangekündigt.}
