...
\begin{enumerate}[label=\textbf{(\arabic*)}, align=left, leftmargin=*]
	...
	\item \textbf{Ankündigung von Leistungen} { \thisfontsize \defkt, Nachschreibearbeiten (\defkt und \defka; auch außerhalb der stundenplanmäßigen Unterrichtszeit), \defsl, \defktp, \catm~sind in der Regel unangekündigt.}
