...
\fancypagestyle{pagestylesimple}{
	...
	\fancyhead[R]{}
	\fancyfoot[L]{\input{\versiondir/VERSION_DOC_LITE.tex}}
	\fancyfoot[C]{\footnotesize ID: \input{\versiondir/commit_tex.tex} }
	\fancyfoot[R]{}
}
...
\fancypagestyle{pagestylefull}{
	...
	\fancyhead[C]{Seite \thepage\ von~\pageref{LastPage}}
	\fancyhead[R]{Hilberg}
	\fancyfoot[L]{\input{\versiondir/VERSION_href.tex}}
	\fancyfoot[C]{\footnotesize ID: \input{\versiondir/commit_repo.tex} }
...
\begin{document}
	...
	\ifthenelse{\boolean{simple}}{
	\begin{description}
		\item[Version Notentransparenz] \input{\versiondir/VERSION_DOC_LITE.tex}\\abrufbar unter \input{\versiondir/VERSION_DOC_LITE_href_with_url.tex}\\ID: \input{\versiondir/commit_tex.tex}
	\end{description}
	}{
	\begin{description}
		\item[Version Notentransparenz] \input{\versiondir/VERSION_href.tex}\\abrufbar unter \input{\versiondir/VERSION_href_with_url.tex}\\ ID: \input{\versiondir/commit_repo.tex}
		\item[Version dieses Dokumentes] \input{\versiondir/VERSION_DOC_href.tex}\\abrufbar unter \input{\versiondir/VERSION_DOC_href_with_url.tex}\\ ID: \input{\versiondir/commit_tex.tex}
	\end{description}
	}
