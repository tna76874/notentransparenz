...
echo "${timestamp_tex_iso}v${commit_count_tex}L" > ${VERSION_DIR}/VERSION_DOC_LITE.tex
...
# LITE DOCUMENT URL
echo "\href{${VERSION_DOC_URL_LITE}}{${VERSION_DOC_URL_LITE}}" > ${VERSION_DIR}/VERSION_DOC_LITE_href_with_url.tex
